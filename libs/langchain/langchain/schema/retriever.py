...
class BaseRetriever(RunnableSerializable[str, List[Document]], ABC):
    ...
    def _get_documents_from_structured_query(
        self, query: str, structured_query,
    ) -> List[Document]:
    ...
    async def aget_runmanager(
        ...
        **kwargs: Any,
        ...
        """Asynchronously get structured query relevant to a query.
        Args:
            query: string to find relevant documents for
            callbacks: Callback manager or list of callbacks
            tags: Optional list of tags associated with the retriever. Defaults to None
    ...
    def get_structured_query(
        ...
        **kwargs: Any,
        ...
        """Retrieve structured query relevant to a query.
        Args:
            query: string to find relevant documents for
            callbacks: Callback manager or list of callbacks
            tags: Optional list of tags associated with the retriever. Defaults to None
        ...
        try:
            _kwargs = kwargs if self.expects_other_args else {}
            if self._new_arg_supported:
                result = self._get_structured_query(
                    query, run_manager=run_manager, **_kwargs
                )
            else:
                result = self._get_structured_query(query, **_kwargs)
        except Exception as e:
            run_manager.on_retriever_error(e)
            raise e
        else:
    ...
    def get_documents_from_structured_query(
        self,
        query: str,
        structured_query,
        callbacks: Callbacks = None,
        ...
        **kwargs: Any,
        ...
        """Retrieve documents fro structured query relevant to a query.
        Args:
            query: string to find relevant documents for
            callbacks: Callback manager or list of callbacks
            tags: Optional list of tags associated with the retriever. Defaults to None
        ...
        try:
            _kwargs = kwargs if self.expects_other_args else {}            
            result = self._get_documents_from_structured_query(
                    query, structured_query, **_kwargs
                )            
        except Exception as e:
            run_manager.on_retriever_error(e)
            raise e
